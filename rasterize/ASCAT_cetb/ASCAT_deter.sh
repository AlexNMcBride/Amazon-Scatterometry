shapes_directory="~/QGIS/cetb_amazon/daily_deter"
...
overlap_directory="~/deforestation/ASCAT_cetb/deter/overlap"
raster_directory="~/deforestation/ASCAT_cetb/deter/rasters"

start_year=2014
end_year=2020

~/Amazon-Scatterometry/rasterize/overlap_analysis.sh $pixels_file $shapes_directory $overlap_directory $start_year $end_year
~/Amazon-Scatterometry/rasterize_overlap.sh $overlap_directory $raster_directory $base_raster $extent

# No deter data in this date range
# start_year=2001
# end_year=2007
