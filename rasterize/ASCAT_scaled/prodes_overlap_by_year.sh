...
overlap_directory="/auto/home/mcbride/deforestation/ASCAT_scaled/prodes_all/overlap"
raster_directory="/auto/home/mcbride/deforestation/ASCAT_scaled/prodes_all/rasters"
start_year=2008
end_year=2024

for year in $(seq $start_year $end_year); do
	/auto/home/mcbride/Amazon-Scatterometry/rasterize/overlap_analysis.sh $pixels_file $shapes_directory $overlap_directory $year $year > "./prodes_logs/prodes_overlap_$year.log" &
done
