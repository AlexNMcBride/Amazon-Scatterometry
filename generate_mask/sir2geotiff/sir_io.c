/* standard C BYU SIR file format i/o routines
   ...
   modified DGL  1 Jun. 2016 + modified to avoid strict compiler warnings, added endian-ness test

   Written in Ansi C 

   (c) copyright 1998, 2000, 2002, 2016 BYU MERS
*/
...
const short isle_var=1;         /* global variable and definitions */
...
/* check endian-ness and SWAP setting */
   if (ISLE) {
#ifndef SWAP
     printf("*** sir_io.c warning: SWAP is incorrectly defined in sir3.h\n");
#endif
   } else {
#ifdef SWAP
     printf("*** sir_io.c warning: SWAP is incorrectly defined in sir3.h\n");
...
*/
   ...
   case 13:
     ...
     break;
   default:
     fprintf(stderr,"\n *** Unrecognized SIR option in write_sir_header3 ***\n");
   }
