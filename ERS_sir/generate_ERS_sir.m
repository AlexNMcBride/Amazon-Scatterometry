...
wdir = sprintf('/auto/home/mcbride/ERS_sir/ERS%d_work/%d',ERS_num,year);
pdir = sprintf('/auto/home/mcbride/ERS_sir/ERS%d_prod/%d',ERS_num,year);
% if ERS_num == 1
%     wdir='/auto/home/mcbride/ERS_sir/ERS1_work';
%     pdir='/auto/home/mcbride/ERS_sir/ERS1_prod';
% else
%     wdir='/auto/home/mcbride/ERS_sir/ERS2_work';
%     pdir='/auto/home/mcbride/ERS_sir/ERS2_prod';
% end

% location of time-ordered ERS .dat files
if ERS_num == 1
  ers_file_name = '/auto/home/mcbride/ERS_sir/work/ERS1_data_files.mat';
  location='/auto/home/mcbride/ERS-1';
else
  ers_file_name = '/auto/home/mcbride/ERS_sir/work/ERS2_data_files.mat';
  location='/auto/home/mcbride/ERS-2';
end
...
for dstart=day:6:last_day
    ...
    % for interval=[0] % test for one day
      ...
      for ireg=1:3
        RegCh=Reg(ireg);
        % create make file
        cmd=sprintf('/auto/home/long/src/linux/newSCP/ERS/bin/ers_meta_make -r /auto/home/long/src/linux/newSCP/ERS/ref -M %s/E2%c_%4.4d_%3.3d_%2.2d.meta ESCAT %d %d %d /auto/home/long/src/linux/newSCP/ERS/def/escat_E2%cB.def %s/%4.4d_%3.3d_%2.2d.flist',wdir,RegCh,year,dstart,interval,dstart,eday,year,RegCh,wdir,year,dstart,interval);
        disp(cmd);
        if ~dry_run
            system(cmd);
        end
        % create GRD and SIR product file
        cmd=sprintf('/auto/home/long/src/linux/newSCP/ERS/bin/ers_cetb_sir -x /auto/home/long/src/linux/newSCP/TRMMPR/bin/fixnc %s -R -s -w %s %s/E2%c_%4.4d_%3.3d_%2.2d.meta',pdir,wdir,wdir,RegCh,year,dstart,interval);
        disp(cmd);
        tstart=tic;
        if ~dry_run
            system(cmd);
